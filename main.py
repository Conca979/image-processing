...
def main():
    parser = argparse.ArgumentParser(description="Convert PNG to ICO with optional background transparency.")
    parser.add_argument("input", help="Path to the input PNG image")
    parser.add_argument("-o", "--output", help="Path to the output ICO image", default="icon.ico")
